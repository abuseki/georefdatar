#' Chondrite
#'
#' A dataset containing the composition of the _CI_ chondrite as given by \insertCite{McDonough_1995}{gcrefer}
#'
...
#'
#' @references{
#'   \insertRef{McDonough_1995}{gcrefer}
#' }
#'
...
#' Pyrolite
#'
#' A dataset containing the _recommended chemical composition of the of the Silicate Earth-''Pyrolite''_ as given in \insertCite{McDonough_1995}{gcrefer}
#'
